    ...
    >
      ...
      <div className="col-span-4 md:col-span-3 mt-24 flex flex-col items-center">
        <div className="flex items-center justify-between w-[95%] mx-auto">
          ...
          <button onClick={() => navigate("/admin/new?q=featured")} className="border border-gray-400 p-2 rounded-md text-sm font-bold hover:bg-gray-800 hover:text-white">Add Top Gift</button>
        </div>
        <div className="p-5 w-full">
          <Datatables query={"top"} />
