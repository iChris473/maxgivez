    ...
    <div className="bg-[#403e38] p-5 flex flex-col md:grid space-y-10 md:grid-cols-4 space-x-2 py-12">
      <div className="flex flex-col justify-center gap-5">
        ...
        <p className="text-gray-300 text-xs md:text-sm">
          Best online store to get qaulity products at affordable prices from
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col items-start gap-2">
          <Link to="/">
            <p className="text-gray-300 text-md">Home</p>
          </Link>
          <Link to="/product">
            <p className="text-gray-300 text-md">Products</p>
          </Link>
          <Link to="/#contactUs">
            <p className="text-gray-300 text-md">Contact Us</p>
          </Link>
          <p className="text-gray-300 text-md">Account</p>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-col items-start gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <p className="text-gray-300 text-xs">+234 903 530 1623</p>
          </div>
          <div className="flex items-center gap-3">
            <MailIcon className="h-5 text-gray-300" />
            <p className="text-gray-300 text-xs">christianjoseph473@gmail.com</p>
          </div>
          {/* <img
